...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -port=<port>           " + strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), MAINNET_P2P_PORT, TESTNET_P2P_PORT) + "\n"; //CHOI_DEBUG
    ...
    strUsage += "  -rpcport=<port>        " + strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 47772, 37772) + "\n";
